...
export const site = {
  ...
  tagline: "I build production web, mobile & AI systems that ship — and scale.",
  ...
  linkedinUrl: "https://www.linkedin.com/in/natnael-denbi-b3534b230",
...
export const projects = [
  ...
  },
  {
    ...
    tags: ["Node.js", "MVP → growth", "Geolocation", "Reviews"],
    accent: "rose",
  },
];
...
export const timeline = [
  ...
  },
  {
    ...
    body: "Alongside intensive competitive programming training (data structures & algorithms) with A2SV — 400+ solved problems on LeetCode and Codeforces.",
  },
];
